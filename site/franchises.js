/* steamprofiler.org - the franchise screens.
   ...
   Two addresses reach the same code:
   ...
   The table below is the whole editorial content of this file and is meant to
   be edited: a franchise is an entry, and a game in one is a line. Every appid
   in it was checked against the storefront rather than remembered, because a
   wrong one is a page about the wrong game with the wrong art on it.
